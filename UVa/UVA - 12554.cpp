...
int main()
{
    ...
    string p[101];
    string ans[17];
    ans[0]="Happy",ans[1]="birthday",ans[2]="to",ans[3]="you",ans[4]="Happy",ans[5]="birthday",ans[6]="to";
    ans[7]="you",ans[8]="Happy",ans[9]="birthday",ans[10]="to",ans[11]="Rujia",ans[12]="Happy",ans[13]="birthday";
    ans[14]="to",ans[15]="you";
    int n;
    cin>>n;
    for(int i=0;i<n;i++)
        cin>>p[i];
